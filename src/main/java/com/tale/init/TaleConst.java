...
public class TaleConst {
    ...
    public static final String ENV_SUPPORT_AUDIO_MUSIC = "app.support_audio_music";
    ...
    public static final String MUSIC_AUDIO_PATTERN     = "\\[audio:(\\s*\\S*)]";
    public static final String MUSIC_AUDIO_TAG          = "<audio src=\"$1\" type=\"audio/mpeg\" autoplay=\"autoplay\" loop=\"loop\"></audio>";
